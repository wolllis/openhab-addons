...
public class EltakoBindingConstants {
    ...
    public static final ThingTypeUID THING_TYPE_FGW14 = new ThingTypeUID(BINDING_ID, "FGW14");
    ...
    public static final Set<ThingTypeUID> SUPPORTED_DEVICE_THING_TYPES_UIDS = new HashSet<>(
            Arrays.asList(THING_TYPE_DSZ14DRS, THING_TYPE_DSZ14WDRS, THING_TYPE_F2L14, THING_TYPE_BGW14,
                    THING_TYPE_F3Z14D, THING_TYPE_F4HK14, THING_TYPE_FAE14LPR, THING_TYPE_FAE14SSR,
                    THING_TYPE_FDG14_BROADCAST, THING_TYPE_FDG14, THING_TYPE_FFR14, THING_TYPE_FGSM14, THING_TYPE_FGW14,
                    THING_TYPE_FHK14, THING_TYPE_FMS14, THING_TYPE_FMSR14, THING_TYPE_FMZ14, THING_TYPE_FPLG14,
                    THING_TYPE_FPLT14, THING_TYPE_FSB14, THING_TYPE_FSDG14, THING_TYPE_FSG14_1_10V, THING_TYPE_FSR14_2X,
                    THING_TYPE_FSR14_4X, THING_TYPE_FSR14SSR, THING_TYPE_FSU14, THING_TYPE_FTD14, THING_TYPE_FTN14,
                    THING_TYPE_FTS14GBZ, THING_TYPE_FTS14KS, THING_TYPE_FTS14TG, THING_TYPE_FUD14_800W,
                    THING_TYPE_FUD14, THING_TYPE_FWG14MS, THING_TYPE_FWZ14_65A, THING_TYPE_FZK14));
    ...
    public static final String FUD14_HARDWARE_VERSION = "hardwareVersion";
    public static final String FUD14_DEVICE_ID = "deviceId";
